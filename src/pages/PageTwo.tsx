  ...
  return (
    <div className="page-container center-flex">
      ...
      <div className="right-side">
        <div className="hook-right pink-hook" data-aos="fade-in" data-aos-delay="100">
          {" "}
        </div>
        <div
          className="hook-right-child"
          data-aos="fade-in"
          data-aos-delay="100"
        ></div>
        <p data-aos="fade-in" data-aos-delay="100">
          Your longest session was on
        </p>
        ...
        <p data-aos="fade-in" data-aos-delay="800">
          Where you scrolled for <span>XXX</span> hours
        </p>
      </div>
    </div>
  );
